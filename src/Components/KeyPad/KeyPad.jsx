  ...
  render() {
    return (
      <div className="keypad">
        ...
        <Button variant='contained' color='primary' value='+' onClick={() => this.props.handleInput('+')}>+</Button>
        <br />
        ...
        <Button variant='contained' style={{color: '#e68a00', fontWeight: 'bolder'}} onClick={() => this.props.handleClear()}>C</Button>
        <Button variant='contained' color='primary'  value='/' onClick={() => this.props.handleInput('*')}>/</Button>
        
        <br />
        {/* make =, clear btn double size */}
        <Button style={{minWidth: '256px', color: 'white', fontWeight: 'bolder'}} color='secondary' 
            variant='contained' value='=' onClick={() => this.props.handleEquals()}>=</Button>
      </div>
    );
  }
}
